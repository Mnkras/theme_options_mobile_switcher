<?php  
	...
	class TOMSBrowser {
		...
		const BROWSER_IE_MOBILE = 'Internet Explorer Mobile';     // http://www.microsoft.com/ie/
		...
		const PLATFORM_WINDOWS_MOBILE = 'Windows Phone OS';
		...
		*/
		 ...
		 */
		 protected function checkBrowsers() {
			return (
				...
				$this->checkBrowserInternetExplorerMobile() ||
	    ...
	    protected function checkBrowserInternetExplorer() {
			if (preg_match('/(windows phone)/i', strtolower($this->_agent))){
	    ...
	    /**
	     * Determine if the browser is Internet Explorer Mobile or not
	     * @return boolean True if the browser is IE Mobile otherwise false
	     */
	    protected function checkBrowserInternetExplorerMobile() {
		    if( stripos($this->_agent,'IEMobile') !== false ) {
			    $aresult = explode('/',stristr($this->_agent,'IEMobile'));
			    //$aversion = explode(' ',$aresult[1]);
			    //$this->setVersion($aversion[0]);
			    $this->setMobile(true);
			    $this->setBrowser(self::BROWSER_INTERNET_EXPLORER_MOBILE);
			    return true;
		    }
		    return false;
	    }
	    ...
	    protected function checkPlatform() {
		    if( stripos($this->_agent, 'windows') !== false ) {
			    ...
			    $this->_platform = self::PLATFORM_WINDOWS_MOBILE;
		    }
